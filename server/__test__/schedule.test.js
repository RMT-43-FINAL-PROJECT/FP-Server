...
describe("GET /schedules", () => {
    test("Success return list schedules", async () => {
        ...
        expect(response.body[0].storeInformations).toHaveProperty("_id", expect.any(String));
        expect(response.body[0].storeInformations).toHaveProperty("name", expect.any(String));
        expect(response.body[0].storeInformations).toHaveProperty("photo", expect.any(String));
        expect(response.body[0].storeInformations).toHaveProperty("address", expect.any(String));
        expect(response.body[0].storeInformations).toHaveProperty("joinDate", expect.any(String));
        expect(response.body[0].storeInformations).toHaveProperty("ownerName", expect.any(String));
        expect(response.body[0].storeInformations).toHaveProperty("mobilePhone", expect.any(String));
        expect(response.body[0].storeInformations).toHaveProperty("status", expect.any(String));
        expect(response.body[0].storeInformations.location).toBeInstanceOf(Object);
        expect(response.body[0].storeInformations.location).toHaveProperty("type", expect.any(String));
        expect(response.body[0].storeInformations.location.coordinates).toBeInstanceOf(Array);
        expect(response.body[0].storeInformations.location.coordinates[0]).toStrictEqual(expect.any(Number));
        expect(response.body[0].storeInformations.location.coordinates[1]).toStrictEqual(expect.any(Number));
        expect(response.body[0].userInformations).toBeInstanceOf(Object);
        expect(response.body[0].userInformations).toHaveProperty("_id", expect.any(String));
        expect(response.body[0].userInformations).toHaveProperty("name", expect.any(String));
        expect(response.body[0].userInformations).toHaveProperty("photo", expect.any(String));
        expect(response.body[0].userInformations).toHaveProperty("joinDate", expect.any(String));
        expect(response.body[0].userInformations).toHaveProperty("email", expect.any(String));
        expect(response.body[0].userInformations).toHaveProperty("mobilePhone", expect.any(String));
        expect(response.body[0].userInformations).toHaveProperty("address", expect.any(String));
        expect(response.body[0].userInformations).toHaveProperty("role", expect.any(String));
    })
})
...
describe("GET /schedules/:scheduleId", () => {
    test("Success return detail schedule", async () => {
        ...
        expect(response.body.storeInformations).toHaveProperty("_id", expect.any(String));
        expect(response.body.storeInformations).toHaveProperty("name", expect.any(String));
        expect(response.body.storeInformations).toHaveProperty("photo", expect.any(String));
        expect(response.body.storeInformations).toHaveProperty("address", expect.any(String));
        expect(response.body.storeInformations).toHaveProperty("joinDate", expect.any(String));
        expect(response.body.storeInformations).toHaveProperty("ownerName", expect.any(String));
        expect(response.body.storeInformations).toHaveProperty("mobilePhone", expect.any(String));
        expect(response.body.storeInformations).toHaveProperty("status", expect.any(String));
        expect(response.body.storeInformations.location).toBeInstanceOf(Object);
        expect(response.body.storeInformations.location).toHaveProperty("type", expect.any(String));
        expect(response.body.storeInformations.location.coordinates).toBeInstanceOf(Array);
        expect(response.body.storeInformations.location.coordinates[0]).toStrictEqual(expect.any(Number));
        expect(response.body.storeInformations.location.coordinates[1]).toStrictEqual(expect.any(Number));
        expect(response.body.userInformations).toBeInstanceOf(Object);
        expect(response.body.userInformations).toHaveProperty("_id", expect.any(String));
        expect(response.body.userInformations).toHaveProperty("name", expect.any(String));
        expect(response.body.userInformations).toHaveProperty("photo", expect.any(String));
        expect(response.body.userInformations).toHaveProperty("joinDate", expect.any(String));
        expect(response.body.userInformations).toHaveProperty("email", expect.any(String));
        expect(response.body.userInformations).toHaveProperty("mobilePhone", expect.any(String));
        expect(response.body.userInformations).toHaveProperty("address", expect.any(String));
        expect(response.body.userInformations).toHaveProperty("role", expect.any(String));
    })
...
describe("POST /schedules", () => {
    ...
    test("salesUser required", async () => {
        ...
        expect(response.status).toBe(400);
        expect(response.body).toBeInstanceOf(Object);
        expect(response.body).toHaveProperty("message", `User/Sales ID is required`);
    });
    test("Schedule time required", async () => {
        ...
        expect(response.status).toBe(400);
        expect(response.body).toBeInstanceOf(Object);
        expect(response.body).toHaveProperty("message", `Schedule time is required`);
    });
    ...
    test("Store Not Verified", async () => {
        ...
        expect(response.status).toBe(400);
        expect(response.body).toBeInstanceOf(Object);
        expect(response.body).toHaveProperty("message", `Store with that ID has not been verified`);
    });
...
describe("DELETE /schedules/:scheduleId", () => {
  ...
  describe("PUT /schedules/:scheduleId", () => {
    ...
    test("isCompleted must be boolean (true/false)", async () => {
        ...
        expect(response.status).toBe(400);
        expect(response.body).toBeInstanceOf(Object);
        expect(response.body).toHaveProperty("message", `isCompleted must be boolean (true/false)`);
    });
});
