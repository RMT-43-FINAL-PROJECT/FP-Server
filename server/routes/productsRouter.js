...
router.post(`/`, authorizationRoleAdmin, upload.single('image'), ProductsController.addProduct);
router.put(`/:id`, authorizationRoleAdmin, upload.single('image'), ProductsController.updateProduct);
